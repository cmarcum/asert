...
#TO-DO
- Add a entity name switch parameter. Currently, entities are called "people."
- Add ability to switch between recursive and non-recursive iteration with support for non-recursive support-set display.
- Add second function for edgewise resolution (though, technically, this can be done currently by creative input formatting).
